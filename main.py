...
# # students = [student for student in students if student['CPSID'] != 10000046]  # Keeps all except the one with CPSID 123456
# # print(students)

# # # Update a specific entry by index
# # students[0]['FName'] = 'quandale'  # Updates the first student's first name
# # students[0]['LName'] = 'dingle'
# # print(students[0])
